...
and returns a greeting - if you have it in your database. It should default to English if the language is
...
def greet(language)
  #LANGUAGES_HASH.fetch(language, 'Welcome')
  LANGUAGES_HASH[language] == nil ? 'Welcome' : LANGUAGES_HASH[language]
end
